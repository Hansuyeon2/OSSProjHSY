...
emotion_mapping = {
    ...
    "평온": ["편안한", "느긋", "안도"],
    "놀람": ["당황",  "충격 받은"],
    "우울": [ "고립된",  "열등감", "부끄러운","가난한 불우한", "슬픔", "실망한",
    "비통한", "후회되는", "우울한", "마비된", "염세적인", "눈물이 나는", "낙담한", "환멸을 느끼는", "외로운", "죄책감의", "상처"],
    "화남": [ "분노", "툴툴대는", "좌절한", "짜증내는", "방어적인", "악의적인", "안달하는", "구역질 나는", "노여워하는", "성가신", "질투하는", "배신당한", "억울한", "괴로워하는"],
    "두려움": ["불안", "두려운", "스트레스 받는", "취약한", "혼란스러운", "당혹스러운", "회의적인", "걱정스러운", "조심스러운", "초조한", "혼란스러운", "희생된", "버려진","남의 시선을 의식하는"]
}
