...
body, button, input, select, table, textarea {font-size:12px;border:none;font-family:"suite","nad", BlinkMacSystemFont, "Malgun Gothic", "맑은 고딕", helvetica, "Apple SD Gothic Neo", sans-serif}
...
@font-face {
    font-family: 'suite';
    src: url('https://cdn.jsdelivr.net/gh/sun-typeface/SUITE@2/fonts/variable/woff2/SUITE-Variable.woff2') format('woff2');
}
